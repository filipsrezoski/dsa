...
public class Zadacha11 {
    public static void mergeSLL(SLL<Integer> lista1, SLL<Integer> lista2, SLL<Integer> lista3){
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0;i<input2;i++){
            lista2.insertLast(Integer.parseInt(parts2[i]));
        }

        SLL<Integer> lista3 = new SLL<>();

        mergeSLL(lista1, lista2, lista3);
    }
}
